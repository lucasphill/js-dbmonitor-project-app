...
export const explanationTopics = [
  ...
  topic("session-total", "connections", "Conexões na lista", "Quantidade de conexões abertas e finalizadas que correspondem aos filtros da lista.", "conexões", "Conjunto observado nesta aplicação; inclui todas as páginas filtradas.", "Atividade de sessões do PostgreSQL e histórico observado em memória.", "A tabela mostra apenas uma página por vez; o histórico é mantido durante a execução da aplicação."),
  ...
  topic("session-finished", "connections", "Finalizada em", "Horário estimado de finalização: a primeira ausência da conexão observada em uma coleta válida.", "data e hora", "Primeira coleta válida em que a conexão não apareceu; exibida no fuso local.", "Comparação entre coletas completas de sessões do PostgreSQL.", "Não representa o instante exato de encerramento no servidor; conexões abertas não têm esse horário."),
